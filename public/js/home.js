...
/*!******************************!*\
  ...
  \******************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _resources_js_app__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../resources/js/app */ "./resources/js/app.ts");
  ...
  btn.addEventListener('click', function (event) {
    if (btn.dataset.action) {
      if (btn.dataset.action === 'login') {
        ...
        // });
        window.location.href = "".concat(_resources_js_app__WEBPACK_IMPORTED_MODULE_0__.baseURL, "/login");
      } else if (btn.dataset.action === 'register') {
        window.location.href = "".concat(_resources_js_app__WEBPACK_IMPORTED_MODULE_0__.baseURL, "/cadastrar/mentor");
      }
    }
  });
});
