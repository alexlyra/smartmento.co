...
"use strict";
/*!************************************!*\
  !*** ./public/pages/auth/login.ts ***!
  \************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var sweetalert2__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! sweetalert2 */ "./node_modules/sweetalert2/dist/sweetalert2.all.js");
/* harmony import */ var sweetalert2__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(sweetalert2__WEBPACK_IMPORTED_MODULE_0__);

var DATA = document.querySelector('json');
var errors = DATA ? JSON.parse("".concat(DATA.getAttribute('errors'))) : JSON.parse('[]');
...
if (errors.length > 0) {
  sweetalert2__WEBPACK_IMPORTED_MODULE_0___default().fire({
    ...
    html: "\n            ".concat(errors.map(function (error) {
      return "<span class=\"text-danger d-block\">".concat(error, "</span>");
    }).join(''), "\n        "),
    customClass: {
