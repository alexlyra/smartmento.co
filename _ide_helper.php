...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function setPrice($userId, $data)
        {
                        /** @var \App\Services\UserService\UserManager $instance */
                        return $instance->setPrice($userId, $data);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function setSegmentsAndInterests($user, $segments)
        {
                        /** @var \App\Services\UserService\UserManager $instance */
                        return $instance->setSegmentsAndInterests($user, $segments);
        }
...
namespace  { 
            ...
            class UserManager extends \App\Services\UserService\UserManagerFacade {}
